...
class Atomatic {
    constructor(elements) {
        ...
        //     const canvas = document.querySelector('canvas.atom').transferControlToOffscreen();
        //     worker.postMessage({ cmd: 'start', structure: this.curAtom, canvas: canvas }, [canvas]);
        // }
        // else {
            renderer = new ThreeRenderer(document.querySelector('canvas.atom'));
