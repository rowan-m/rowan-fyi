...
class WatchHand {
  constructor(config) {
    ...
    this.path = [
      ...
      `a${this.pointXR - this.armW / 2} ${this.pointYR} 1 0 1 ${this
        .pointXR -
      this.armW / 2} ${this.pointYR}`,
      // central pivot
...
class SvgRenderer {
  ...
  rotateNumbers(watch) {
    let gRot =
      (Math.atan2(watch.accel.y, watch.accel.x) * 180) / Math.PI - 90;
...
const hands = {
  second: new WatchHand({ handL: 390, faceR: 500, pointXR: 10, pointYR: 10, pivotOR: 30, pivotIR: 10, armW: 5 }),
  minute: new WatchHand({ handL: 410, faceR: 500, pointXR: 35, pointYR: 55, pivotOR: 35, pivotIR: 10, armW: 33 }),
  hour: new WatchHand({ handL: 310, faceR: 500, pointXR: 35, pointYR: 55, pivotOR: 35, pivotIR: 10, armW: 33 }),
};
